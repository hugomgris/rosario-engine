...
// Iterates over all entities with an InputComponent and polls Raylib
// for the keys assigned to their player slot.
// Entities with no assigned slot (e.g. AI-controlled snakes) are skipped.
